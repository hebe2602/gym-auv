...
def plot_multiple_stats(df_list, label_list, var_list, var_labels_list, xaxis='episodes', window_size=100, n_timesteps = 1000000):
    ...
    for i, var in enumerate(var_list):
        ...
        plt.savefig(f'/Users/henrikstoklandberg/Documents/NTNU/gym-auv/plots/{var}.pdf', bbox_inches='tight')
        plt.clf()
        plt.cla()
...
if __name__ == '__main__':
    ...
    filenames = ['1conv_baseline_stats', '1conv_locked_stats','1conv_unlocked_stats']
    ...
    label_list = ['1conv random', '1conv locked', '1conv unlocked']
    # Variables to plot
