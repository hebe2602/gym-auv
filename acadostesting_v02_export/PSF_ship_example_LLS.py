...
def main():
    ...
    ocp.constraints.lbx = np.array([-xy_max,-xy_max,-uvr_max,-uvr_max])
    ocp.constraints.ubx = np.array([+xy_max,+xy_max,+uvr_max,+uvr_max])
    ocp.constraints.idxbx = np.array([0,1,3,4])
    ocp.constraints.lbx_e = 0.25*np.array([-xy_max,-xy_max,-uvr_max,-uvr_max])
    ocp.constraints.ubx_e = 0.25*np.array([+xy_max,+xy_max,+uvr_max,+uvr_max])
